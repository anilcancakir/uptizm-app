...
///
/// ```dart
/// // Convert to MagicStarterTeam for the magic_starter team resolver
/// final magicStarterTeam = team.toMagicStarterTeam();
/// ```
class Team extends Model with HasTimestamps, InteractsWithPersistence {
  ...
  ///   currentTeam: () async => (await Team.find(currentId))?.toMagicStarterTeam(),
  ///   allTeams: () async => (await Team.all()).map((t) => t.toMagicStarterTeam()).toList(),
  /// );
  /// ```
