...
class MonitorFormValues {
  ...
  factory MonitorFormValues.fromMap(Map<String, dynamic> data) {
    ...
    return MonitorFormValues(
      ...
      regions: regions.isEmpty ? const {'eu-west'} : regions,
